...
namespace ChitChat.ViewModels
{
    public class HomeViewModel : ViewModelBase
    {
        ...
        public HomeViewModel(IHttpService httpService, ISocketService socketService)
        {
        ...
        public SecureString Password
        {
            ...
            set
            {
                _password = value;
                if (InRegisterScreen)
                    if (value.Length < 1) PasswordConstraintMessage = "Password must be 1 or longer in length!";
        ...
        {
            return await _socketService.PostLoginCredentialsAsync(new UserCredentials(_currentUserName, "abc"));
        }
